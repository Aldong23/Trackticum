...
public class CompanyMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CompanyMessageAdapter(Context context, List<Message> messageList, String currentCompanyId) {
    ...
    public int getItemViewType(int position) {
        ...
        return message.getSenderType().equals("company") ? VIEW_TYPE_SENT : VIEW_TYPE_RECEIVED;
    }
