...
public class StudentMessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StudentMessageAdapter(Context context, List<Message> messageList, String currentUserId) {
    ...
    public int getItemViewType(int position) {
        ...
        return message.getSenderType().equals("student") ? VIEW_TYPE_SENT : VIEW_TYPE_RECEIVED;
    }
