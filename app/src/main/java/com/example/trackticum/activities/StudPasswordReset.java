...
public class StudPasswordReset extends AppCompatActivity {

    private Toolbar toolbar;
    ProgressDialog progressDialog;

    private TextInputEditText otpET;
    Button submitBTN, studLoginBTN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stud_password_reset);
        setupWindowInsets();
    ...
    private void initializeData() {
        ...
        studLoginBTN = findViewById(R.id.stud_login_link);
    }
    ...
    private void setupListeners() {
        ...
        studLoginBTN.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(StudPasswordReset.this, StudLogin.class);
    ...
    private void resetPassword(String otp) {
        ...
        String url = Constants.API_BASE_URL + "/student/stud-reset-password";
