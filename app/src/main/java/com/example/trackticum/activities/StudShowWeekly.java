...
public class StudShowWeekly extends AppCompatActivity implements ActivityAdapter.ActivityActions {
    ...
    Button downloadBtn;
    TextView evaluationTv, commentTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stud_show_weekly);
        setupWindowInsets();
    ...
    private void initializeData() {
        ...
        evaluationTv = findViewById(R.id.evaluation_tv);
        ...
        adapter = new ActivityAdapter(this, activitiesList, this);
    ...
    private void setupListeners() {
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                LayoutInflater inflater = LayoutInflater.from(StudShowWeekly.this);
                View dialogView = inflater.inflate(R.layout.dialog_add_activity, null);

                // Initialize views
                TextInputEditText activitiesEditText = dialogView.findViewById(R.id.activities_et);
                TextInputEditText dateEditText = dialogView.findViewById(R.id.dateInput);
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(StudShowWeekly.this);
                builder.setTitle("Add Weekly Activities")
                        .setView(dialogView)
                        .setPositiveButton("Save", (dialog, which) -> {
                            String enteredAct = activitiesEditText.getText().toString().trim();
                            String enteredDate = dateEditText.getText().toString().trim();

                            if (!enteredAct.isEmpty() && !enteredDate.isEmpty()) {
                               addActivity(enteredAct, enteredDate);
                            } else {
                                Toast.makeText(StudShowWeekly.this, "Please enter your activities", Toast.LENGTH_SHORT).show();
                            }
                        })
    ...
    private void addActivity(String enteredAct, String enteredDate) {
        progressDialog.setMessage("Please wait...");
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = Constants.API_BASE_URL + "/student/add-activities";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                response -> {
                    ...
                    try {
                        ...
                        Toast.makeText(StudShowWeekly.this, message, Toast.LENGTH_LONG).show();
                        fetchActivities();
                        //request to refresh weekly list
                        sharedPreferences.edit().putBoolean("refreshWeeklyList", true).apply();
                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(StudShowWeekly.this, "Error parsing response", Toast.LENGTH_SHORT).show();
                    }
                }, error -> {
            progressDialog.dismiss();
            Toast.makeText(StudShowWeekly.this, "Failed to add", Toast.LENGTH_SHORT).show();
        }) {
            @Override
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<>();
                params.put("weekly_id", weeklyID);
                params.put("date", enteredDate);
                params.put("activities", enteredAct);
                params.put("is_signed", "0");
                return params;
            }
        };
    ...
    private void fetchWeeklyDetails() {
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, response -> {
            try {
                ...
                evaluationTv.setText(evaluation.equals("null") ? "None" : evaluation); // set to none if .equals("null")
                commentTv.setText(comment.equals("null") ? "None" : comment); // set to none if .equals("null")
    ...
    private void saveWeekly(String weeklyTitle) {
        progressDialog.setMessage("Please wait...");
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = Constants.API_BASE_URL + "/student/edit-weekly";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            progressDialog.dismiss();
            Toast.makeText(StudShowWeekly.this, "Failed to save", Toast.LENGTH_SHORT).show();
        }) {
            @Override
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<>();
    ...
    private void deleteRecord() {
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = Constants.API_BASE_URL + "/student/delete-weekly/" + weeklyID;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                response -> {
                    ...
                    try {
                        ...
                        Intent intent = new Intent(StudShowWeekly.this, StudViewWeekly.class);
                ...
                error -> {
                    progressDialog.dismiss();
                    Toast.makeText(StudShowWeekly.this, "Failed to delete", Toast.LENGTH_SHORT).show();
                });
    ...
    private void fetchActivities() {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url, null,
                ...
                error -> Toast.makeText(StudShowWeekly.this, "Failed to fetch activities", Toast.LENGTH_SHORT).show()
        );
    ...
    private void deleteActivity(String activityId) {
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = Constants.API_BASE_URL + "/student/delete-activity/" + activityId + "/" + weeklyID;
    ...
    private void editActivity(String activityId, String enteredAct, String enteredDate) {
        progressDialog.setMessage("Please wait...");
        ...
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = Constants.API_BASE_URL + "/student/edit-activities";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
            ...
            progressDialog.dismiss();
            Toast.makeText(StudShowWeekly.this, "Failed to edit", Toast.LENGTH_SHORT).show();
        }) {
            @Override
            protected Map<String, String> getParams() {
                Map<String, String> params = new HashMap<>();
    ...
    @Override
    public void onEditActivity(String activityId, String date, String activities) {
        LayoutInflater inflater = LayoutInflater.from(StudShowWeekly.this);
        View dialogView = inflater.inflate(R.layout.dialog_add_activity, null);
        ...
        builder.setTitle("Edit")
                ...
                .setPositiveButton("Save", (dialog, which) -> {
                    ...
                    if (!enteredAct.isEmpty() && !enteredDate.isEmpty()) {
                        editActivity(activityId, enteredAct, enteredDate);
                    } else {
                        Toast.makeText(StudShowWeekly.this, "Please enter your activities", Toast.LENGTH_SHORT).show();
                    }
                })
    ...
    public void onDeleteActivity(String activityId) {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Delete", (dialog, which) -> {
                    // Call the delete method when confirmed
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.show_weekly_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            String weeklyTitle = titleEt.getText().toString().trim();
            if (!weeklyTitle.isEmpty()) {
                titleEt.clearFocus();
                saveWeekly(weeklyTitle);
            } else {
                Toast.makeText(StudShowWeekly.this, "Please enter a valid title.", Toast.LENGTH_SHORT).show();
            }
