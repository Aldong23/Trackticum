...
public class ComForgotPassword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com_forgot_password);
        setupWindowInsets();
    ...
    private void processForgotPassword(String email) {
        ...
        String url = Constants.API_BASE_URL + "/company/com-process-forgot-password";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                response -> {
                    ...
                    try {
                        ...
                        if (status) {
                            String companyID = jsonResponse.getString("company_id");
                            Intent intent = new Intent(ComForgotPassword.this, ComPasswordReset.class);
