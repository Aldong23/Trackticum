...
public class StudMessageCom extends AppCompatActivity {
    ...
    String studId, companyId, companyName;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_stud_message_com);
        setupWindowInsets();
    ...
    private void initializeData() {
        ...
        adapter = new StudentMessageAdapter(this, messageList, studId);
    ...
    private void sendMessage(String message) {
        ...
        String url = Constants.API_BASE_URL + "/student/send-company-message";
    ...
    private void fetchMessage() {
        String url = Constants.API_BASE_URL + "/student/get-company-messages/" + companyId + "/" + studId;
    ...
    private void messageEventListener() {
        ...
        Channel channel = pusher.subscribe("chat.company-" + companyId + "-student-" + studId);
