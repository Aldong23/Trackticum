...
public class StudShowDtr extends AppCompatActivity implements StudDtrAdapter.StudDtrVAction {
    ...
    Button donwloadBTN;
    private ExtendedFloatingActionButton addDtrButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stud_show_dtr);
        setupWindowInsets();
    ...
    private void initializeData() {
        //set up action bar
        toolbar = findViewById(R.id.stud_show_dtr_toolbar);
        ...
        addDtrButton = findViewById(R.id.add_dtr_btn);
        ...
        donwloadBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(actionFilter != null){
                    ...
                    Toast.makeText(StudShowDtr.this, "Please Select Month", Toast.LENGTH_SHORT).show();
                }

            }
        });
        addDtrButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View clickview) {
                AlertDialog.Builder builder = new AlertDialog.Builder(clickview.getContext());
                builder.setTitle("Add DTR");

                LayoutInflater inflater = LayoutInflater.from(clickview.getContext());
                View dialogView = inflater.inflate(R.layout.dialog_add_dtr, null);
                builder.setView(dialogView);

                // Initialize Date and Time inputs
                TextInputEditText dateInput = dialogView.findViewById(R.id.dateInput);
                TextInputEditText amTimeIn = dialogView.findViewById(R.id.amTimeInInput);
                TextInputEditText amTimeOut = dialogView.findViewById(R.id.amTimeOutInput);
                TextInputEditText pmTimeIn = dialogView.findViewById(R.id.pmTimeInInput);
                TextInputEditText pmTimeOut = dialogView.findViewById(R.id.pmTimeOutInput);
                ...
                dateInput.setOnClickListener(v -> {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(clickview.getContext(),
                ...
                // Time Picker on Click (Same for all fields)
                View.OnClickListener timeClickListener = v -> {
                    ...
                    TimePickerDialog timePickerDialog = new TimePickerDialog(clickview.getContext(), (view, hourOfDay, minuteOfDay) -> {
                ...
                amTimeIn.setOnClickListener(timeClickListener);
                amTimeOut.setOnClickListener(timeClickListener);
                pmTimeIn.setOnClickListener(timeClickListener);
                pmTimeOut.setOnClickListener(timeClickListener);

                // Save button
                builder.setPositiveButton("Add", (dialog, which) -> {
                    String selected_date = dateInput.getText().toString();
                    String am_in = amTimeIn.getText().toString();
                    String am_out = amTimeOut.getText().toString();
                    String pm_in = pmTimeIn.getText().toString();
                    String pm_out = pmTimeOut.getText().toString();

                   addDtrToDb(selected_date, am_in, am_out, pm_in, pm_out);
                });
    ...
    private void addDtrToDb(String selectedDate, String amIn, String amOut, String pmIn, String pmOut) {
        if (selectedDate.isEmpty() || amIn.isEmpty() || amOut.isEmpty() || pmIn.isEmpty() || pmOut.isEmpty()) {
            ...
            String url = Constants.API_BASE_URL + "/student/add-dtr";
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    response -> {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(StudShowDtr.this, "Error parsing response", Toast.LENGTH_SHORT).show();
                        }
                    }, error -> {
                progressDialog.dismiss();
                Toast.makeText(StudShowDtr.this, "Failed to add", Toast.LENGTH_SHORT).show();
            }) {
                @Override
                protected Map<String, String> getParams() {
                    Map<String, String> params = new HashMap<>();
                    params.put("stud_id", studID);
                    params.put("selected_date", selectedDate);
    ...
    public void onViewDtr(String dtrId, String amTimeIn, String amTimeOut, String pmTimeIn, String pmTimeOut, String isSigned) {
        ...
        builder.setPositiveButton("Save", (dialog, which) -> {
            ...
            saveDtr(dtrId, am_in, am_out, pm_in, pm_out, "0");
        });
...
//                            studSexET.setAdapter(adapterItems);
                ...
                progressDialog.dismiss();
                Toast.makeText(StudShowDtr.this, "Failed to update", Toast.LENGTH_SHORT).show();
            }) {
                @Override
                protected Map<String, String> getParams() {
                    Map<String, String> params = new HashMap<>();
...
//                        fetchMonthFilter();
                ...
                error -> {
                    progressDialog.dismiss();
                    Toast.makeText(StudShowDtr.this, "Failed to delete DTR", Toast.LENGTH_SHORT).show();
                });
